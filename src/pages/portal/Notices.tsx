        ...
        <article style={{ background: "white", borderRadius: "1rem", padding: "1.5rem 2rem", border: "1px solid #e2e8f0" }}>
          ...
          {selected.attachments.length > 0 && (
            <div style={{ borderTop: "1px solid #f1f5f9", paddingTop: "1rem", marginTop: "1.5rem" }}>
              <h3 style={{ fontSize: "0.875rem", fontWeight: 600, marginBottom: "0.75rem", color: "#64748b" }}>첨부파일</h3>
  ...
  return (
    <div className="portal-page-container">
      <div style={{ marginBottom: "1.5rem" }}>
        <p style={{ fontSize: "0.75rem", color: "#3b82f6", fontWeight: 700, letterSpacing: "0.1em", margin: 0 }}>NOTICES</p>
        <h1 style={{ fontSize: "1.75rem", fontWeight: 800, color: "#0f172a", margin: "0.25rem 0 0.5rem", letterSpacing: "-0.02em" }}>교회 소식</h1>
        <p style={{ color: "#64748b" }}>공지와 행사 소식을 확인하세요.</p>
      </div>
      ...
      <div style={{ display: "flex", gap: "0.5rem", marginBottom: "1.5rem", overflowX: "auto", paddingBottom: "0.25rem" }}>
        {categories.map((c) => (
          ...
          >
            {c === "all" ? "전체" : categoryLabels[c as AnnouncementCategory]}
          </button>
        ))}
      </div>
